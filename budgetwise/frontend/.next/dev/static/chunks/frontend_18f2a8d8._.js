...
"[project]/frontend/src/store/auth.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[value]": ()=>({
                ...
                token,
                login: ({
                    "AuthProvider.useMemo[value]": (t, u)=>{
                        setToken(t);
                        setUser(u);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        fileName: "[project]/frontend/src/store/auth.tsx",
        lineNumber: 49,
        columnNumber: 10
    }, this);
}
_s(AuthProvider, "Qmet5/W+RHZGuUSZKVTq6+KJn48=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=frontend_18f2a8d8._.js.map